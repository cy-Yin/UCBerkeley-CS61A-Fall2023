...
def max_path_sum(t):
    ...
    if is_leaf(t):
        ...
        path_sum_node_t_max = label(t) + max_path_sum(branches(t)[0])
        for branch in branches(t):
            path_sum_node_t = label(t) + max_path_sum(branch)
            if path_sum_node_t > path_sum_node_t_max:
                path_sum_node_t_max = path_sum_node_t
        return path_sum_node_t_max
...
def has_path(t, word):
    ...
    if label(t) != word[0]:
        ...
        for branch in branches(t):
            if has_path(branch, word[1:]) == True:
                return True
        return False
